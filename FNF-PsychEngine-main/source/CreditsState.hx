...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['The Mod'],
		['Game banana',		'banana',		'',					'https://gamebanana.com/mods/166531',	0xFFFFFF00],
		['Person that ported the mod'],
		['Burn',		'Burn',		'Person that ported the mod',					'https://twitter.com/Burn89089760',	0xFF0000FF],
        ['OG Mod Makers'],
		['atsuover',		'atsuover',		'Voice samples and Coding',					'https://gamebanana.com/members/1792259',	0xFFFF0000],
		['Rageminer',		'rageminer',		'Art and Music with Coding',					'https://gamebanana.com/members/1789102',	0xFF00FFFF],
		['Psych Engine Team'],
